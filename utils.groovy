        ...
        dir("extras/01_IaC_Automate_AWS_infra"){
            sh("""
                terraform init \
                  ...
                  -backend-config="key=${env.PROJECT_NAME}/${env.S3_BACKEND_BUCKET}" \
...
def deployApplication() {
    echo "[deployApplication]: SERVER ADDRESS TO SSH: ${EC2_SERVER_IP}"

    echo "[deployApplication]: 90 sec sleep before asking podman to do something"
